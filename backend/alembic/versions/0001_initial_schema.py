...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('verification_type', sa.Enum('none', 'email_edu', 'student_id', name='verificationtype'), nullable=False, server_default='none'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='proposalstatus'), nullable=False, server_default='pending'),
